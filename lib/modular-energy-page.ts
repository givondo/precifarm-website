...
export const modularEnergyPaths = {
 ...
 miniStack: "/charging/modular-energy/mini-stack",
 megapack: "/charging/modular-energy/megapack",
} as const;

export type ModularEnergyProductSlug = "p1-go" | "p2-home" | "mini-stack";

/** Handled by app/charging/modular-energy/[slug]/page.tsx */
export const modularEnergyProductSlugs = ["p1-go", "p2-home", "mini-stack"] as const satisfies readonly ModularEnergyProductSlug[];

export const modularEnergyStatusNote =
 "Conceptual platform as design targets and renders show intent, not a certified product for sale.";
...
export const modularEnergyNav = {
 ...
 { href: modularEnergyPaths.miniStack, label: "Mini Stack", slug: "mini-stack" as const },
 ],
 megapack: {
...
/**
 * Platform voice. Keep these lines consistent wherever modular energy appears as 
 * overview, product pages, nav descriptions and cross-links from charging.
 */
export const modularEnergyBrand = {
 /** Primary positioning line as what the platform is, in one sentence. */
 positioning:
 ...
 /** Honest status language as reuse verbatim rather than inventing new phrasing. */
 status: {
...
/** Why the platform is modular as the argument behind the product family. */
export const modularEnergyPrinciples = [
 {
 id: "one-block",
 label: "One block",
 title: "The same 2.56 kWh module in every product",
 text: "P1 Go, P2 Home and Mini Stack are built around one capacity block — one spare part, one test rig, one service procedure.",
 },
 {
 id: "size-to-load",
 label: "Sized to load",
 title: "Buy the hours you need, add bays later",
 text: "Start at one module and grow to four in P2, or two to six in Mini Stack, without replacing the Power Core or inverter.",
 },
 {
 id: "serviceable",
 label: "Serviceable",
...
export const modularEnergyAvailability = {
 ...
 text: "Home charger with 5 or 10 kWh built-in storage — a separate product from Mini Stack.",
 href: "/charging/home",
 },
 {
 ...
 { name: "Mini Stack", text: "2–6 module outdoor enclosure for retail sites." },
...
export const modularEnergyPage = {
 ...
 { label: "Mini Stack enclosure", value: "2–6 modules", note: "Outdoor plinth for retail sites" },
 ] as const,
 principlesSection: {
 eyebrow: "Why modular",
 ...
 title: "Portable P1 Go, home P2 tower, outdoor Mini Stack — MegaPack for projects",
 caption: "P1 Go, P2 Home and Mini Stack share the 2.56 kWh block. MegaPack is a separate line, engineered per site for factories, EV hubs and grid-connected plants.",
 items: [
 {
 ...
 description:
 "Where the hardware goes changes everything about it as indoor or outdoor, wall or plinth, essential loads or a whole charging hub.",
 cards: [
 {
 setting: "Urban home",
 ...
 rows: [
 ["Pulse · 7 kW wallbox", "Charges the car overnight on your meter. P2 Home or Mini Stack covers the house when the grid dips and puts daytime solar surplus to use."],
 ["Spark · 3.3 kW portable", "The charger you keep in the boot. P1 Go is a backup pack with a Type 2 trickle lead for emergencies as it does not replace Spark."],
 ...
 faqs: [
 {
 question: "Can I buy P1 Go, P2 Home or Mini Stack today?",
 answer:
 ...
 answer:
 "No. MegaPack is a separate line, engineered and quoted per project for industrial, EV-hub and grid-connected sites. P1 Go, P2 Home and Mini Stack are the products that share the 2.56 kWh Energy Module, and they stay at home and shop scale.",
 },
 {
 ...
 {
 question: "Is Mini Stack the same as Pod energy storage?",
 answer:
 "No. Pod energy storage is a home charger with 5 or 10 kWh built in, and we install it today. Mini Stack is the conceptual outdoor enclosure that holds two to six Energy Modules at a retail site.",
 },
 {
 ...
 description:
 "Send us the appliances you need through a dip and how long the power usually stays off. We will size it, quote what we can commission now as Pulse, storage, solar as and say plainly what is still on the platform roadmap.",
 primaryHref: "/contact",
...
export type ModularEnergyProduct = {
 ...
 title: string;
 description: string;
 /** One line on who this is for as shown above the hero headline. */
 audience: string;
 image: string;
 imageAlt: string;
...
export const modularEnergyProducts: Record<ModularEnergyProductSlug, ModularEnergyProduct> = {
 ...
 ["EV", "Type 2 trickle only as not daily charging"],
 ],
 ...
 text: "The boot charger for a typical day as about 180 minutes on a 13 A socket.",
 href: "/charging",
 },
 {
 name: "Pulse · 7 kW home wallbox",
 ...
 answer:
 "Not yet as P1 Go is conceptual. Get in touch if you want to be part of early access conversations, and we will tell you what we can supply in the meantime.",
 },
 ],
 },
 "p2-home": {
 ...
 {
 name: "Pod energy storage",
 text: "A home charger with 5 or 10 kWh of storage built in — a different product from Mini Stack.",
 href: "/charging/home",
 },
 {
 ...
 features: {
 eyebrow: "Where it fits",
 title: "What Mini Stack protects on a retail site",
 },
 worksWith: {
 eyebrow: "Available today",
 title: "Site energy work we can quote for your shop now",
 description:
 "Mini Stack is design intent. A site visit today can still cover solar, storage and charging for a commercial premises.",
 },
 },
 ...
 specCaption: "Prototype targets for Mini Stack. Nothing here is certified or final.",
 features: [
 {
 ...
 answer:
 "Because most street-front premises have no utility room to give up, and floor space indoors is selling space. Mini Stack mounts outdoors on a plinth with wall shade and a service door, so the footprint costs you nothing in trading area.",
 },
 {
 ...
 question: "Is Mini Stack the same as Pod energy storage?",
 answer:
 "No. Pod energy storage is a home charger with 5 or 10 kWh built in, and we install it today. Mini Stack is this conceptual outdoor enclosure for retail sites.",
 },
 {
