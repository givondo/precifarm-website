...
export const publicRoutes = [
  ...
  { path: modularEnergyPaths.podStack, label: "Pod Stack", changefreq: "monthly" as const, priority: 0.72 },
  ...
  { path: "/download", label: "Precifarm Agent", changefreq: "monthly" as const, priority: 0.7 },
