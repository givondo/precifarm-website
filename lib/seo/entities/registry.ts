...
/**
 * Seed knowledge graph as extensible via CMS.
...
export const entityRegistry: KnowledgeEntity[] = [
 ...
 name: "Precifarm",
 description:
 "Kenyan electric mobility infrastructure company as charging, storage and operations for homes, fleets and highways.",
 url: siteConfig.url,
 ...
 name: "Boda Hub",
 description:
 "Battery swap for electric bodas as attendant or partner sites today; automated self-service lockers on the product roadmap.",
 url: absoluteUrl("/charging/boda-hub"),
 ...
 description: "Corridor charging at Precifarm hubs as about 60 kWh in 30 minutes, paid with M-Pesa.",
 url: absoluteUrl("/charging"),
 ...
 description:
 "AI electrical and energy engineering workspace for EV charging, solar, batteries and electrical systems. Desktop coming soon.",
 ...
 description:
 "Conceptual home and shop storage family as P1 Go, P2 Home and Mini Stack share one 2.56 kWh Energy Module. Not on sale yet.",
 ...
 type: "equipment",
 name: "MegaPack",
 description: "Project-engineered BESS for industrial sites, EV hubs and grid-connected plants as quoted per site.",
...
export function internalLinksForPath(path: string): { href: string; label: string; reason: string }[] {
 ...
 add("/charging/home", "Home EV charging", "Pulse charger and Pod energy storage");
 add("/charging/boda-hub", "Automated Boda Hub", "Self-service e-motorcycle battery swap");
 add("/partners", "Fleet EV charging", "Partner operator services");
 add("/evs", "Kenya EV guide", "Which charger fits your EV");
 break;
 case "/charging/boda-hub":
 add(chargingHub.path, chargingHub.label, "Live and coming-soon swap sites");
 add("/partners", "Partner programmes", "Host a Boda Hub site");
 add("/agent", "Precifarm Agent", "AI electrical & energy engineer");
 ...
 break;
 case "/agent":
 add("/download", "Desktop download", "Request early access");
 ...
 break;
 case "/download":
 add("/agent", "Precifarm Agent", "Product overview");
 add("/contact", "Contact", "Request desktop access");
 add("/charging", "EV charging", "Spark charger to Corridor");
 break;
 case "/partners":
 add("/charging", "EV charging", "From home charging to highway charging");
